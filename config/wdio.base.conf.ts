...
export const baseConfig: WebdriverIO.Config = {
  ...
  specs: ['./tests/specs/ui/**/*.spec.ts', './tests/specs/api/*.api.ts'],
  suites: {
    api: ['./tests/specs/api/*.api.ts'],
    book: ['./tests/specs/ui/book/*.spec.ts'],
    login: ['./tests/specs/ui/login/login.spec.ts'],
    regression: ['./tests/specs/ui/**/*.spec.ts'],
    register: ['./tests/specs/ui/register/register.spec.ts'],
  },
  exclude: [],
  maxInstances: 5,
  capabilities: [
